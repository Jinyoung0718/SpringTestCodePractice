...
public class MyCalculatorRepeatableTest {
    ...
    @DisplayName("파라미터를 넣으며 사칙연산 2번 함")
    @ParameterizedTest
    @MethodSource("parameterizedComplicatedCalculateParameterTest")
    public void parameterizedComplicatedCalculateTest(
        ...
        // then
        Assertions.assertEquals(exponentValue, result);
    }

    public static Stream<Arguments> parameterizedComplicatedCalculateParameterTest() {
        return Stream.of(
