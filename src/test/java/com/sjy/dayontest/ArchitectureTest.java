...
public class ArchitectureTest {
    ...
    public void beforeEach() {
        javaClasses = new ClassFileImporter()
                        ...
                        .importPackages("com.sjy.dayontest");
    }
    ...
    @Test
    @DisplayName("controller 는 Service 와 Request/Response 를 사용할 수 있음")
    ...
    @Test
    @DisplayName("Service 는  Controller 를 의존하면 안됨")
    ...
    @Test
    @DisplayName("Model 는 오직 Service와 Repository에 의해 의존됨")
    ...
    public void modelDependencyTest2() {
        ArchRule rule = classes()
                .that().resideInAnyPackage("..model..")
                .should().dependOnClassesThat().resideInAnyPackage("..model..", "java..", "jakarta..");
